    ...
    if(err){
      ...
      var html = template.HTML(sanitizedTitle, list,
        ...
        ` <a href="/topic/create/">create</a>
          ...
          <form action="/topic/:pageID/delete_process/" method="post">
...
app.post('/topic/:pageID/delete_process/', function(request, response){
...
app.use(function(req,res,next){
  response.status(404).send('Sorry cannot find that! Gyuwon write');
});
